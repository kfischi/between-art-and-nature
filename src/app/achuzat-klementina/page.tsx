...
export const metadata: Metadata = {
  title: 'אחוזת קלמנטין — בין אומנות לטבע',
  description: 'וילה היסטורית בגליל התחתון. בריכה פרטית, ג׳קוזי, קמין ואפשרות לשבתות חתן ואירועים.',
}

export default function AchuzatKlentinaPage() {
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(260px, 1fr))', gap: '1.5px' }}>
          {loc.features.map((f, i) => (
            <ScrollReveal key={i} delay={i * 0.1}>
              <div style={{
                background: 'var(--log)', border: '1px solid rgba(122,158,95,.1)',
      ...
      <section style={{ padding: '6rem 4rem', background: 'var(--soil)', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '5rem', alignItems: 'center' }}>
        <ScrollReveal>
          ...
          <h2 style={{ fontFamily: "'Frank Ruhl Libre', Georgia, serif", fontSize: 'clamp(2rem, 3.5vw, 3.8rem)', fontWeight: 300, lineHeight: 1.05, marginBottom: '2rem' }}>
            <em style={{ fontStyle: 'italic', color: loc.color }}>אחוזת קלמנטין</em><br />
            — הסיפור
          </h2>
        ...
        <ScrollReveal delay={0.2}>
          <div style={{ position: 'relative', height: '60vh' }}>
            ...
            <div style={{
              ...
              background: 'var(--bark)', border: `1px solid rgba(${loc.colorRgb},.2)`,
              ...
              <div style={{ fontSize: '.7rem', color: 'var(--muted)', letterSpacing: '.08em' }}>
                החל מ- / לילה
              </div>
            </div>
          </div>
