...
export const locations = {
  'galilee-estate': {
    ...
    seoKeywords: ["אחוזה בגליל", "אירוח יוקרה", "גליל עליון"]
  },
  'pekiin': {
    name: "פקיעין",
    ...
    imageFeatured: "https://res.cloudinary.com/decirk3zb/image/upload/v1772466322/7_a09vce.jpg",
    gallery: [
    ...
    seoKeywords: ["פקיעין", "אירוח אותנטי", "סוויטות יוקרה"]
  },
  'zuriel': {
    name: "אחוזת צוריאל",
  ...
  'clementine': {
    ...
    imageFeatured: "https://res.cloudinary.com/decirk3zb/image/upload/v1772466327/10_fvnm0t.jpg",
    gallery: [
    ...
    seoKeywords: ["אחוזת קלמנטינה", "חופשה רומנטית", "אירוח יוקרה"]
  }
};
