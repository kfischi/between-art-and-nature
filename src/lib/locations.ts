...
export const locations: Location[] = [
  ...
  // ══════════════════════════════════════════
  {
    ...
    rooms: [
      { name: 'חדר שינה ראשי', capacity: '2 אורחים', beds: 'מיטה זוגית קינג', features: ['חדר אמבטיה פרטי', 'ארון מרווח', 'מזגן'], icon: '🛏️' },
      { name: 'חדר שינה 2', capacity: '2 אורחים', beds: 'מיטה זוגית', features: ['גישה לאמבטיה משותפת', 'מזגן'], icon: '🛏️' },
      { name: 'חדר שינה 3', capacity: '4 אורחים', beds: '2 מיטות זוגיות', features: ['מתאים למשפחות', 'מזגן'], icon: '🛏️' },
      { name: 'חדר שינה 4', capacity: '4 אורחים', beds: '4 מיטות יחיד', features: ['מתאים לילדים או צוות', 'מזגן'], icon: '🛏️' },
      { name: 'סוויטת בונוס', capacity: '2 אורחים', beds: 'מיטה זוגית', features: ['חדר אמבטיה עצמאי', 'כניסה נפרדת', 'פרטיות מלאה'], icon: '✨' },
    ],
    forWho: [
      { icon: '👨‍👩‍👧‍👦', title: 'משפחות גדולות', description: 'חצר בטוחה לילדים, בריכה, BBQ. כשכולם מתאספים — זה המקום הנכון.' },
      { icon: '💑', title: 'זוגות שרוצים פינוק', description: 'ג׳קוזי, קמין, גינה שקטה. לפעמים הכי טוב זה פשוט לא לצאת מהאחוזה.' },
      { icon: '✡️', title: 'שבת חתן', description: 'הפרדה מלאה, תנאים לכשרות, לוגיסטיקה מנוסה. כניסו לשבת בלי ולו דאגה אחת.' },
      { icon: '🎉', title: 'אירועים וחגיגות', description: 'ימי הולדת, יובלות, כינוסי משפחה. עד 50 אורחים עם מקום לנשום.' },
      { icon: '🤝', title: 'ימי גיבוש', description: 'חברות שרוצות לחזק קשרים מחוץ למשרד — פה יוצא טוב.' },
    ],
    amenities: [
      ...
      { category: '🛋️ נוחות ושינה', items: ['5 חדרי שינה', 'סלון גדול עם קמין', 'טלוויזיות', 'מזגנים בכל חדר'] },
    ...
    attractions: [
      { name: 'נחר קישון ורכיבה על סוסים', distance: '8 ק"מ', type: 'טבע', description: 'חוות סוסים עם סיורים מודרכים לאורך נחל קישון המשוקם', icon: '🐴' },
      { name: 'הר הכרמל ושמורת הכרמל', distance: '20 ק"מ', type: 'טבע', description: 'יערות עצי אלון ועצי זית עתיקים, שבילי טיול לכל הרמות', icon: '🌲' },
      { name: 'עכו העתיקה — עיר מורשת עולמית', distance: '35 ק"מ', type: 'תרבות', description: 'מנהרות הצלבנים, שוק העיר העתיקה, חומות ים עוצרות נשימה', icon: '🏛️' },
      { name: 'מגידו — נפוליאון ומלכי ישראל', distance: '18 ק"מ', type: 'היסטוריה', description: 'אתר מורשת עולמי של יונסקו. שכבות ציביליזציה מ-7,000 שנה', icon: '⚔️' },
      { name: 'בית שאן ועמק המעיינות', distance: '40 ק"מ', type: 'טבע', description: 'מעיינות חמים, שמורת גן השלושה, האמפיתיאטר הרומי', icon: '🏺' },
      { name: 'יקבי בוטיק — גליל תחתון', distance: '15-25 ק"מ', type: 'אוכל ויין', description: 'יקב גלנה, יקב כרמי יוסף — סיורים וטעימות בתיאום מראש', icon: '🍷' },
    ],
    trails: [
  ...
  // ══════════════════════════════════════════
  {
    ...
    rooms: [
      { name: 'חדר שינה ראשי', capacity: '2 אורחים', beds: 'מיטה זוגית קינג', features: ['נוף מהחלון', 'חדר אמבטיה פרטי', 'מזגן'], icon: '🛏️' },
      { name: 'חדר שינה 2', capacity: '2 אורחים', beds: '2 מיטות יחיד / ניתן לחבר', features: ['מתאים לילדים', 'מזגן'], icon: '🛏️' },
      { name: 'מרפסת ג׳קוזי', capacity: 'עד 4 אורחים', beds: '—', features: ['ג׳קוזי חיצוני', 'נוף פנורמי', 'פרטיות מלאה'], icon: '🛁' },
    ],
    forWho: [
      { icon: '💑', title: 'זוגות שמחפשים בריחה', description: 'ג׳קוזי, קמין, אין אף אחד. לפעמים הכי אינטימי זה להיות מוקפי טבע.' },
      { icon: '👨‍👩‍👧', title: 'משפחה קטנה', description: 'מקום בטוח, שקט, ומרחב שמאפשר לילדים לגלות את הטבע מקרוב.' },
      { icon: '🧘', title: 'ריטריט אישי', description: 'אם אתם צריכים לנתק, לכתוב, לחשוב, או פשוט לא לעשות כלום — זה בדיוק כאן.' },
      { icon: '📸', title: 'צלמים ויוצרים', description: 'הנוף בשעת הזהב, הכוכבים בלילה, ואור הבוקר המיוחד של הגליל.' },
    ],
    amenities: [
    ...
    attractions: [
      { name: 'נחל כזיב — נחל קלה', distance: '15 ק"מ', type: 'טבע', description: 'אחד הנחלים הנאים בישראל עם בריכות טבע, מפלים ועצי פלטנוס עצומים', icon: '💧' },
      { name: 'מצודת יחיעם', distance: '8 ק"מ', type: 'היסטוריה', description: 'מבצר צלבני מרשים בראש גבעה עם נוף על הכרמל והגליל', icon: '🏰' },
      { name: 'פארק הכרמל — חוף הים', distance: '30 ק"מ', type: 'טבע', description: 'מהרים לים בפחות מחצי שעה — חוף בת גלים, חוף שקמונה', icon: '🏖️' },
      { name: 'כפר ורד — רכיבה על סוסים', distance: '20 ק"מ', type: 'הרפתקה', description: 'טיולי סוסים מודרכים לשמורות ונחלים של הגליל המערבי', icon: '🐴' },
      { name: 'עכו — עיר מורשת עולמית', distance: '25 ק"מ', type: 'תרבות', description: 'מנהרות הצלבנים, שוק הזייתונה, חומות ים ויאכטות. חצי יום מינימום', icon: '⚓' },
      { name: 'פסטיבל עכו — אוקטובר', distance: '25 ק"מ', type: 'תרבות', description: 'פסטיבל תיאטרון בינלאומי שמפלש את כל הרחובות העתיקים', icon: '🎭' },
    ],
    trails: [
  ...
  // ══════════════════════════════════════════
  {
    ...
    rooms: [
      { name: 'בית ראשי', capacity: '8 אורחים', beds: '4 חדרי שינה', features: ['מטבח מלא', 'סלון גדול', 'מזגן'], icon: '🏠' },
      { name: 'צריף בוהמיאני', capacity: '4 אורחים', beds: '2 חדרי שינה', features: ['עיצוב ייחודי', 'מרפסת', 'כניסה עצמאית'], icon: '🌿' },
      { name: 'אוהל גלאמפינג', capacity: '2-4 אורחים', beds: 'מיטה זוגית + ספות', features: ['חוויה ייחודית', 'רצפת עץ', 'תאורת פיות'], icon: '⛺' },
    ],
    forWho: [
      { icon: '👨‍👩‍👧‍👦', title: 'משפחות גדולות', description: 'שדות לרוץ בהם, BBQ לבשל ביחד, ושקט שילדים אוהבים גם בלי לדעת.' },
      { icon: '✡️', title: 'שבת חתן', description: 'שטח גדול להפרדה, מקום לתפילה, לוגיסטיקה של שנות ניסיון.' },
      { icon: '🎉', title: 'ימי הולדת וחגיגות', description: 'BBQ, שדות, מקום לרחפן — לחגיגות שמרגישות שונות.' },
      { icon: '🤝', title: 'ימי גיבוש', description: 'יציאה מהמשרד לטבע. כשמבשלים יחד, מדברים יחד.' },
    ],
    amenities: [
      ...
      { category: '🛋️ לינה', items: ['3 אפשרויות לינה', 'מצעים ומגבות', 'מזגנים', 'חדרי שירותים מרווחים'] },
    ...
    attractions: [
      { name: 'צפת — עיר הקבלה', distance: '25 ק"מ', type: 'תרבות ורוחניות', description: 'עיר האמנים, הרובע היהודי העתיק, גלריות וסמטאות מרוצפות אבן', icon: '🕯️' },
      { name: 'ים כנרת', distance: '35 ק"מ', type: 'טבע', description: 'הים הפנימי הגדול בישראל. שחייה, קיאקים, רכיבת אופניים על שפת המים', icon: '🌊' },
      { name: 'נחל עמוד', distance: '20 ק"מ', type: 'טבע', description: 'ממערות הפרהיסטוריה ועד הכנרת — נחל עם מפלים ובריכות לאורך כל הדרך', icon: '🏞️' },
      { name: 'כנרת ודגניה — ראשית הציונות', distance: '40 ק"מ', type: 'היסטוריה', description: 'הקיבוצים הראשונים, בית גורדון, קבר רחל המשוררת', icon: '📜' },
      { name: 'יקב גולן — רמת הגולן', distance: '45 ק"מ', type: 'אוכל ויין', description: 'מבקרים ביקב, טועמים יינות פרמיום עם נוף לרמת הגולן', icon: '🍷' },
    ],
    trails: [
  ...
  // ══════════════════════════════════════════
  {
    ...
    features: ['🏛️ ארכיטקטורה עתיקה', '🥙 תרבות דרוזית', '🥾 שבילי טבע', '📜 היסטוריה', '🤫 שקט מוחלט'],
    ...
    rooms: [
      { name: 'בית האבן', capacity: '4 אורחים', beds: '2 חדרי שינה', features: ['אבן גיר מקורית', 'קמרון', 'חצר פנימית'], icon: '🏛️' },
      { name: 'חדר הגינה', capacity: '2 אורחים', beds: 'מיטה זוגית', features: ['גינה סמויה', 'נוף הרים', 'כניסה עצמאית'], icon: '🌿' },
    ],
    forWho: [
      { icon: '🏛️', title: 'אוהבי היסטוריה ותרבות', description: 'כל אבן כאן מספרת סיפור. תבואו עם סקרנות ותצאו עם סיפורים.' },
      { icon: '💑', title: 'זוגות שמחפשים ייחודי', description: 'לא בית מלון, לא ריזורט. בית אמיתי בכפר עם אלפי שנים של היסטוריה.' },
      { icon: '🧘', title: 'ריטריט ויוגה', description: 'האוויר הנקי, השקט, והסביבה — מושלם לימי ריטריט קטנים.' },
      { icon: '📸', title: 'צלמים ואמנים', description: 'כל פינה בפקיעין היא תמונה. הארכיטקטורה, האנשים, האור.' },
    ],
    amenities: [
      { category: '🏛️ ייחודי למקום', items: ['ארכיטקטורה עתיקה מקורית', 'חצר פנימית', 'קמרונות אבן', 'גינה מסורתית'] },
    ...
    attractions: [
      { name: 'הר מירון — קבר רשב"י', distance: '15 ק"מ', type: 'רוחניות', description: 'ההר הגבוה ביותר בגליל. קבר האר"י, קבר שמעון בר יוחאי, נוף לכנרת', icon: '✡️' },
      { name: 'נחר עמוד — מהמקורות', distance: '10 ק"מ', type: 'טבע', description: 'מצאינו מים לאורך כל השנה. בריכות, מפלים, עצי שיזף עתיקים', icon: '💧' },
      { name: 'מערות עכברה', distance: '12 ק"מ', type: 'טבע', description: 'מערות סמוך לצפת עם עטלפים, אחת מהמושבות הגדולות בישראל', icon: '🦇' },
      { name: 'ראש פינה — רחוב הגלריות', distance: '20 ק"מ', type: 'תרבות', description: 'הכפר הציוני הראשון. גלריות אמנות, מסעדות גורמה, נוף לגולן', icon: '🎨' },
      { name: 'בריכת הנגריה — מג׳ד אל-כרום', distance: '8 ק"מ', type: 'טבע', description: 'בריכת טבע לשחייה עם מים מתגלגלים בתוך גן ירוק', icon: '🏊' },
    ],
    trails: [
