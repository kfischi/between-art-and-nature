export const locations = {
  'galilee-estate': {
    ...
    image: "https://res.cloudinary.com/decirk3zb/image/upload/v1772401384/1_h9zhkx.webp", // התמונה הראשית
    imageFeatured: "https://res.cloudinary.com/decirk3zb/image/upload/v1772401403/10_wkxsda.webp", // תמונת ה-Hero
    gallery: [
    ...
    seoKeywords: ["אחוזה בגליל", "אירוח יוקרה", "גליל עליון", "עיצוב פנים"]
  },
  'pekiin': {
    name: "פקיעין",
    ...
    seoKeywords: ["פקיעין", "אירוח אותנטי", "סוויטות יוקרה", "אומנות וטבע"]
  }
};
